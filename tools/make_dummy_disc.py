...
#   0x000  game ID (6): "GDUMMY"  (fixture code, not a real title)
...
print(f"wrote {out} ({MINI_DVD_SIZE} bytes sparse, magic {GAMECUBE_DISC_MAGIC:#010x})")
