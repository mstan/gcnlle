...
/*
 * Verbatim segher descrambler. Do not "clean up" the bit math — every term is
 * load-bearing and the LFSRs desync silently (producing plausible-looking
 * garbage) if the ordering or a constant is off by a bit.
 */
