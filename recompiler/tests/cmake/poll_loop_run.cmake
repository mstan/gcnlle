execute_process(
    ...
    RESULT_VARIABLE gen_result OUTPUT_VARIABLE gen_stdout ERROR_VARIABLE gen_stderr
)
if(NOT gen_result EQUAL 0)
    message(FATAL_ERROR "poll-loop generation failed:\n${gen_stdout}\n${gen_stderr}")
endif()

get_filename_component(output_dir "${OUTPUT_C}" DIRECTORY)
set(check_src_dir "${output_dir}/poll_loop_check_project")
set(check_build_dir "${output_dir}/poll_loop_check_build")
...
project(PollLoopCheck C)
set(CMAKE_C_STANDARD 11)
set(CMAKE_C_STANDARD_REQUIRED ON)
add_executable(poll_loop_check \"${output_c_cmake}\" \"${harness_src_cmake}\")
target_include_directories(poll_loop_check PRIVATE \"${repo_src_cmake}\")
")
...
if(NOT configure_result EQUAL 0)
    message(FATAL_ERROR "poll-loop configure failed:\n${configure_stdout}\n${configure_stderr}")
endif()
...
execute_process(COMMAND "${CMAKE_COMMAND}" ${build_args}
    RESULT_VARIABLE build_result OUTPUT_VARIABLE build_stdout ERROR_VARIABLE build_stderr)
if(NOT build_result EQUAL 0)
    message(FATAL_ERROR "poll-loop check did not build:\n${build_stdout}\n${build_stderr}")
endif()

set(exe_candidates "${check_build_dir}/poll_loop_check${CMAKE_EXECUTABLE_SUFFIX}"
                   "${check_build_dir}/poll_loop_check.exe")
if(DEFINED HOST_BUILD_CONFIG AND NOT HOST_BUILD_CONFIG STREQUAL "")
    list(APPEND exe_candidates "${check_build_dir}/${HOST_BUILD_CONFIG}/poll_loop_check${CMAKE_EXECUTABLE_SUFFIX}"
                               "${check_build_dir}/${HOST_BUILD_CONFIG}/poll_loop_check.exe")
endif()
set(exe_path "")
...
if(exe_path STREQUAL "")
    message(FATAL_ERROR "poll_loop_check executable not found: ${exe_candidates}")
endif()
...
if(NOT run_result EQUAL 0)
    message(FATAL_ERROR "poll_loop_check failed (exit ${run_result}):\n${run_stdout}\n${run_stderr}")
endif()
